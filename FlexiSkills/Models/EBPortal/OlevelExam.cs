...
namespace FlexiSkills.Models.EBPortal
{
    [Keyless]
    [Table("OLevelExams")]
    public partial class OlevelExam
    {
        [StringLength(50)]
        [Unicode(false)]
        ...
        [ForeignKey("Olenid1")]
        public virtual OlevelExamName Olenid1Navigation { get; set; } = null!;
        [ForeignKey("Olenid2")]
        public virtual OlevelExamName Olenid2Navigation { get; set; } = null!;
    }
}
